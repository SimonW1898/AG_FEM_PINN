...
def run_with_potential(dir='run_potential'):
    ...
    # Note: No analytical solution available for potential case, so no analytical animations
...
if __name__ == "__main__":
    ...
    # time_solver = run_with_potential("cn_potential")
    ...
    animate_from_npz(
        ...
        plot_type='abs', 
        plot_3d=True, 
        save_path="euler_potential/animation_3d_small_dt.gif", 
        save_frames=False,
        max_time=1.0,
        total_duration=5.0,
        n_frames=100
