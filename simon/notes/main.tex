...
$$a(u,v) = \frac{i}{\dt} \int_{\Omega} u^{t + \dt} \bar{v} -  \int_{\Omega} V(x,t) u^{t + \dt} \bar{v} + \int_{\Omega} \nabla u^{t + \dt} \cdot \nabla \bar{v}$$ is a sesquilinear form.
And the right-hand side: $$L(v) = \frac{i}{\dt} \int_{\Omega} u^t \bar{v}  $$ is a bounded linear functional.
