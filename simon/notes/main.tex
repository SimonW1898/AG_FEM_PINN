...
We use the variational formulation of the Schrödinger equation derived above, by setting $V(x,t) = 0$.
...
We solve the problem with the FEM and show the evolution of the solution at different times in Figure \ref{fig:free_solution_evolution}.
...
We can see that the solution is a standing wave, which is expected for the free Schrödinger equation.
...
We solve the problem with the PINN and show the evolution of the solution at different times in Figure \ref{fig:free_solution_evolution_pinn}.
